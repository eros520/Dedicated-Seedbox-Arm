...
source <(wget -qO- https://raw.githubusercontent.com/eros520/Seedbox-Components-Arm/main/Miscellaneous/tput.sh)
...
source <(wget -qO- https://raw.githubusercontent.com/eros520/Seedbox-Components-Arm/main/tweaking.sh)
CPU_Tweaking
NIC_Tweaking
...
wget https://raw.githubusercontent.com/eros520/Seedbox-Components-Arm/main/Miscellaneous/.boot-script.sh && chmod +x .boot-script.sh
